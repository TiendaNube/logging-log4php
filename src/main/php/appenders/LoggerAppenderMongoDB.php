...
class LoggerAppenderMongoDB extends LoggerAppender {
	...
	final const DEFAULT_MONGO_URL_PREFIX = 'mongodb://';

	/** Default value for {@link $host}, without a prefix. */
	final const DEFAULT_MONGO_HOST = 'localhost';

	/** Default value for {@link $port} */
	final const DEFAULT_MONGO_PORT = 27017;

	/** Default value for {@link $databaseName} */
	final const DEFAULT_DB_NAME = 'log4php_mongodb';

	/** Default value for {@link $collectionName} */
	final const DEFAULT_COLLECTION_NAME = 'logs';

	/** Default value for {@link $timeout} */
	final const DEFAULT_TIMEOUT_VALUE = 3000;
	...
	protected $databaseName = self::DEFAULT_DB_NAME;
	...
	protected $timeout = self::DEFAULT_TIMEOUT_VALUE;
