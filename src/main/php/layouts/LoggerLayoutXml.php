...
class LoggerLayoutXml extends LoggerLayout {
	final const LOG4J_NS_PREFIX ='log4j';
	final const LOG4J_NS = 'http://jakarta.apache.org/log4j/';

	final const LOG4PHP_NS_PREFIX = 'log4php';
	final const LOG4PHP_NS = 'http://logging.apache.org/log4php/';

	final const CDATA_START = '<![CDATA[';
	final const CDATA_END = ']]>';
	final const CDATA_PSEUDO_END = ']]&gt;';
	final const CDATA_EMBEDDED_END = ']]>]]&gt;<![CDATA[';
	...
	public function format(LoggerLoggingEvent $event) {
		...
		if ($this->getLocationInfo()) {
			...
			$buf .= "<$ns:locationInfo ".
					...
					"file=\"" .  htmlentities((string)$locationInfo->getFileName(), ENT_QUOTES) . "\" ".
