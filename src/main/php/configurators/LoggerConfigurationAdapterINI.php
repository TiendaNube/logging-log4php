...
class LoggerConfigurationAdapterINI implements LoggerConfigurationAdapter {
	...
	final const ROOT_LOGGER_NAME = "root";

	/** Prefix used for defining logger additivity. */
	final const ADDITIVITY_PREFIX = "log4php.additivity.";

	/** Prefix used for defining logger threshold. */
	final const THRESHOLD_PREFIX = "log4php.threshold";

	/** Prefix used for defining the root logger. */
	final const ROOT_LOGGER_PREFIX = "log4php.rootLogger";

	/** Prefix used for defining a logger. */
	final const LOGGER_PREFIX = "log4php.logger.";

	/** Prefix used for defining an appender. */
	final const APPENDER_PREFIX = "log4php.appender.";

	/** Prefix used for defining a renderer. */
	final const RENDERER_PREFIX = "log4php.renderer.";
